		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart Table",
									"targetURL": "#commitsmarttablesmarttable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commitsmarttablesmarttable-display": {
								"semanticObject": "commitsmarttablesmarttable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mit.smarttable.smarttable",
									"url": sap.ui.require.toUrl("com/mit/smarttable/smarttable")
								}
							}
						}
					}
